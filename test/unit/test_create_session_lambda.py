...
class TestCreateSession(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.db_host = 'photo-ranker-db-dev.c5yogmykmh2v.us-east-2.rds.amazonaws.com'
        self.db_name = 'photoranker'
        self.db_user = 'photorankeradmin'
        self.db_password = 'photoR4nk3r'
    ...
    def test_create_session_in_postgres(self) -> None:
        ...
        try:
            ...
            self.fail(f"Failed to retrieve item from Postgres: {str(e)}")
